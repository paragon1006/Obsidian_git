...
// src/main.ts
var FinDocPlugin = class extends import_obsidian5.Plugin {
  loadSettings() {
    return __async(this, null, function* () {
      ...
      try {
        ...
        this.registerMarkdownCodeBlockProcessor("findoc", (src, el, ctx) => __async(this, null, function* () {
          try {
            ...
            const content = (0, import_obsidian5.parseYaml)(src);
            if (!content || !content.filename) {
              new import_obsidian5.Notice("No Content or No Filename", 1e4);
              return;
            }
            if (content.filename) {
              const filename = (0, import_obsidian5.normalizePath)(`${activeFile.parent.path}/${content.filename}`);
              ...
              if (chartData) {
                ...
                new import_obsidian5.Notice("Unable to generate chart", 1e4);
              }
            }
          } catch (e) {
            new import_obsidian5.Notice(e.message, 1e4);
            throw e;
          }
        }));
      } catch (e) {
